...
const CompanySetup = () => {
  ...
  // Fetch existing company details and pre-fill everything
  useEffect(() => {
  ...
  const onSubmit = async (data) => {
    ...
    // Only append a new file if the user picked one; otherwise backend keeps the old logo
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">
            Update your company details, branding, and culture.
          </p>
        </div>
